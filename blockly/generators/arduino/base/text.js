...
Blockly.Arduino['text_compare'] = function(block) {
  var str1 = Blockly.Arduino.valueToCode(block, 'STR1',
      Blockly.Arduino.ORDER_UNARY_POSTFIX) || '\"\"';
  var str2 = Blockly.Arduino.valueToCode(block, 'STR2',
      Blockly.Arduino.ORDER_UNARY_POSTFIX) || '\"\"';
  str1 = 'String(' + str1 + ')';
  str2 = 'String(' + str2 + ')';
  var code = str1+'.compareTo('+str2+')';
  return [code, Blockly.Arduino.ORDER_UNARY_POSTFIX];
};
//字符串截取
Blockly.Arduino['text_subsrting'] = function(block) {
  var str = Blockly.Arduino.valueToCode(block, 'STR',
      Blockly.Arduino.ORDER_UNARY_POSTFIX) || '\"\"';
  var start = Blockly.Arduino.valueToCode(block, 'START',
      Blockly.Arduino.ORDER_UNARY_POSTFIX) || '\"\"';
  var length = Blockly.Arduino.valueToCode(block, 'LENGTH',
      Blockly.Arduino.ORDER_UNARY_POSTFIX) || '\"\"';
  str = 'String(' + str + ')';
...
//字符串转int
Blockly.Arduino['text_parse_int'] = function(block) {
  var str = Blockly.Arduino.valueToCode(block, 'STR',
      Blockly.Arduino.ORDER_UNARY_POSTFIX) || '\"\"';
  str = 'String(' + str + ')';
  var code = str+'.toInt()';
...
//int转字符串
Blockly.Arduino['int_to_text'] = function(block) {
...
//字符串根据索引获取字符
Blockly.Arduino['text_get_char'] = function(block) {
  var str = Blockly.Arduino.valueToCode(block, 'STR',
      Blockly.Arduino.ORDER_UNARY_POSTFIX) || '\"\"';
