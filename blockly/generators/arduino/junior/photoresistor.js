...
goog.provide('Blockly.Arduino.photoresistor');
...
Blockly.Arduino['photoresistor_get_value'] = function(block) {
  var code = 'photoresistor_get_value()';
  Blockly.Arduino.photoresistor.init();
  return [code,Blockly.Arduino.ORDER_UNARY_POSTFIX];
};

Blockly.Arduino.photoresistor.init = function(){
