...
goog.provide('Blockly.Arduino.thermistor');
...
Blockly.Arduino['thermistor_get_value'] = function(block) {
  var code = 'thermistor_get_value()';
  Blockly.Arduino.thermistor.init();
  return [code,Blockly.Arduino.ORDER_UNARY_POSTFIX];
};

Blockly.Arduino.thermistor.init = function(){
