...
/**
 * @fileoverview Generating JavaScript code for the loop blocks.
 *
 ...
 * statement.
 * JavaScript code: loop { for (let count = 0; count < X; count++) { Y } }
 ...
 * JavaScript code: loop { while (X) { Y } }
 * @param {!Blockly.Block} block Block to generate the code from.
 * @return {string} Completed code.
 */
Blockly.JavaScript['controls_whileUntil'] = function(block) {
  ...
  var argument0 = Blockly.JavaScript.valueToCode(block, 'BOOL',
      until ? Blockly.JavaScript.ORDER_LOGICAL_OR :
 ...
 * JavaScript code: loop { for (i = X; i <= Y; i+=Z) { } }
 * @param {!Blockly.Block} block Block to generate the code from.
 * @return {string} Completed code.
 */
 ...
 * @return {string} Completed code.
 */
Blockly.JavaScript['controls_forEach'] = Blockly.JavaScript.noGeneratorCodeLine;

/**
 * Generator for the loop flow control statements.
 * JavaScript code: loop { break;/continue; }
 * @param {!Blockly.Block} block Block to generate the code from.
 * @return {string} Completed code.
 */
