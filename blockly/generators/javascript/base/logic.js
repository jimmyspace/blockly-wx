...
/**
 * @fileoverview Generating JavaScript code for the logic blocks.
 */
'use strict';
 ...
 * JavaScript code: loop { if (X)/else if ()/else { X } }
 ...
 * JavaScript code: loop { true/false }
 * @param {!Blockly.Block} block Block to generate the code from.
 * @return {array} Completed code with order of operation.
 */
...
Blockly.JavaScript['logic_ternary'] = function(block) {
  var valueIf = Blockly.JavaScript.valueToCode(block, 'IF',
      Blockly.JavaScript.ORDER_CONDITIONAL) || 'false';
  var valueThen = Blockly.JavaScript.valueToCode(block, 'THEN',
      Blockly.JavaScript.ORDER_CONDITIONAL) || 'null';
  var valueElse = Blockly.JavaScript.valueToCode(block, 'ELSE',
      Blockly.JavaScript.ORDER_CONDITIONAL) || 'null';
