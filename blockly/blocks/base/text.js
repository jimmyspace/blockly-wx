...
Blockly.Blocks['text_prompt'] = {
 ...
 //自定义块
  ...
  Blockly.Blocks['text_compare'] = {
    init: function() {
      this.jsonInit({
        /*"message0": Blockly.Msg.TEXT_COMPARE_TITLE,*/
        "message0": "比较 %1 与 %2",
        "args0": [
          {
            "type": "input_value",
        ...
        "colour": Blockly.Blocks.texts.HUE,
        "tooltip": "",
        "helpUrl": Blockly.Msg.TEXT_COMPARE_HELP_URL
      });
    },
    /** Assigns a type to the block, prompt always returns a string. */
    getBlockType: function() {
  ...
  //字符串截取
  Blockly.Blocks['text_subsrting'] = {
    init: function() {
    this.jsonInit({
      /*"message0": Blockly.Msg.TEXT_SUBSRTING_TITLE,*/
      "message0": " %1 的子字符串,起始位置 %2 ，长度 %3 ",
      "args0": [
        {
          "type": "input_value",
          "name": "STR",
      ...
      "colour": Blockly.Blocks.texts.HUE,
      "tooltip": "",
      "helpUrl": Blockly.Msg.TEXT_SUBSRTING_HELP_URL
    });
    },
    /** Assigns a type to the block, prompt always returns a string. */
    getBlockType: function() {
  ...
  //字符串转int
  Blockly.Blocks['text_parse_int'] = {
    init: function() {
    this.jsonInit({
      /*"message0": Blockly.Msg.TEXT_PARSE_INT_TITLE,*/
      "message0": "把 %1 转换成数字",
      "args0": [
      {
        "type": "input_value",
    ...
    "colour": Blockly.Blocks.texts.HUE,
    "tooltip": "",
    "helpUrl": Blockly.Msg.TEXT_PARSE_INT_HELP_URL
    });
    },
    /** Assigns a type to the block, prompt always returns a string. */
    getBlockType: function() {
  ...
  //字符串根据索引获取字符
  Blockly.Blocks['text_get_char'] = {
    init: function() {
    this.jsonInit({
   /* "message0": Blockly.Msg.TEXT_GET_CHAR_TITLE,*/
   "message0": "从 %1 中提取字符位置 %2 ",
    "args0": [
      {
        "type": "input_value",
        "name": "STR",
    ...
    "colour": Blockly.Blocks.texts.HUE,
    "tooltip": "",
    "helpUrl": Blockly.Msg.TEXT_GET_CHAR_HELP_URL
    });
    },
    /** Assigns a type to the block, prompt always returns a string. */
    getBlockType: function() {
